...
![Stock one ui 6.1 on Samsung Galaxy Tab A7 Lite](./main.png)

**Stock one ui 6.1 on Samsung Galaxy Tab A7 Lite (gta7lite/gta7litewifi)**
...
![odih4 Tool Screenshot](./flashing-tool.png)
...
1. Flash recovery:
```bash
fastboot flash boot images/recovery.img
```
...
![UBports recovery on Samsung Galaxy Tab A7 Lite](./RECOVERY.png)
